...
class SliderControl(Node):
    ...
    def sliderCallback(self, msg):
        ...
        arm_controller.joint_names = ["ltts_joint1", "ltts_joint2", "ltts_joint3", "ltts_joint4", "ltts_joint5", "ltts_joint6", "ltts_joint7"]
        gripper_controller.joint_names = ["ltts_finger_joint1"]
